...
My philosophy is not an absolutely new philosophy as far as file system is concerned. It brings about an improvement in the first philosophy wherein it treats the extension of the file just for display purpose.

# Optimizations
Listed below are the optimizations this philosophy brings about:
