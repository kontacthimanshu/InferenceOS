...
IOS_USED const char ios_user_application_name[] = "InferenceOS Custom Test";
volatile ios_u64 ios_custom_test_shell_endpoint;
...
ios_i64 ios_user_main(ios_u64 application_identity)
{
    ...
    ios_custom_test_shell_endpoint = runtime.shell.endpoint_handle;
