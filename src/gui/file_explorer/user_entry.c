...
IOS_USED const char ios_user_application_name[] = "InferenceOS File Explorer";
volatile ios_u64 ios_file_explorer_shell_endpoint;
...
ios_i64 ios_user_main(ios_u64 application_identity)
{
    ...
    ios_file_explorer_shell_endpoint = runtime.shell.endpoint_handle;
