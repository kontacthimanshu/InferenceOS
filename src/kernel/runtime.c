...
enum {
    ...
    IOS_RUNTIME_EXPLORER_WIDTH = 624,
    IOS_RUNTIME_EXPLORER_HEIGHT = 704,
    IOS_RUNTIME_EXPLORER_X = 32,
    ...
    IOS_RUNTIME_TXT_VIEWER_WIDTH = 320,
    IOS_RUNTIME_TXT_VIEWER_HEIGHT = 360,
    IOS_RUNTIME_TXT_VIEWER_X = 672,
    IOS_RUNTIME_TXT_VIEWER_Y = 32
};

IOS_STATIC_ASSERT(
    IOS_RUNTIME_EXPLORER_WIDTH * IOS_RUNTIME_EXPLORER_HEIGHT
        > IOS_RUNTIME_DOC_VIEWER_WIDTH * IOS_RUNTIME_DOC_VIEWER_HEIGHT
            + IOS_RUNTIME_TXT_VIEWER_WIDTH * IOS_RUNTIME_TXT_VIEWER_HEIGHT,
    "File Explorer must have more desktop area than both file viewer applications combined"
);
